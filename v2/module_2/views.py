...
def submit_quiz(request, pk):
    if request.method == "POST":
        try:
            ...
            # If module2 is already completed, skip the submission
            if certificate.module2:
                return JsonResponse({
                    "message": "You have already completed this module.",
                    "score": certificate.english  # Return the existing score if already completed
                })
            ...
            # Save the updated score and mark module2 as completed
